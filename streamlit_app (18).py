...
_PROFIT_LOGO = "data:image/svg+xml;base64,"
...
.block-container { padding: 0.8rem 1.5rem 3rem !important; max-width: 100% !important; }
div[data-testid="stVerticalBlock"] { gap: 0.25rem; }
/* מניעת חיתוך header */
header[data-testid="stHeader"] { background: #1F3A5F !important; }
...
def _check_password() -> bool:
    ...
    # עמוד כניסה — הכל ממורכז עם columns
...
'>
  <img src="{_PROFIT_LOGO}"
       style='height:70px; margin-bottom:20px; object-fit:contain; display:block; margin-left:auto; margin-right:auto;'>
  <div style='width:36px;height:3px;background:#A31235;margin:0 auto 16px;border-radius:2px'></div>
  <div style='font-size:10px;color:#A31235;margin-bottom:8px;letter-spacing:0.14em;font-weight:700'>
    PROFIT MIX OPTIMIZER
  </div>
  <div style='font-size:24px;font-weight:900;color:#1F3A5F;margin-bottom:4px'>
    כניסה למערכת
  </div>
...
<div class="pmo-header">
  <div class="pmo-header-left">
    <img src="{_PROFIT_LOGO}"
         style='height:38px;object-fit:contain;flex-shrink:0'>
  ...
  <table class='res-tbl'>
    ...
    <tbody>{rows_h}</tbody>
        ...
        if not bar_df.empty:
            ...
            # גרף אנכי עם תוויות זוויתיות — מציג טקסט מלא
            fig = go.Figure(go.Bar(
                x=bar_df["קרן"],
                y=bar_df[bar_metric],
                marker_color=colors,
            ...
            fig.update_layout(
                height=420,
                margin=dict(t=30, b=180, l=10, r=10),
                xaxis=dict(
                    tickangle=-45,
