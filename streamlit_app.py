...
_PROFIT_LOGO = "data:image/png;base64,"
...
.block-container { padding: 0.5rem 1.5rem 3rem !important; max-width: 100% !important; }
...
'>
  ...
  <img src="{_PROFIT_LOGO}"
       style='height:90px; margin-bottom:32px; object-fit:contain;'>

  <!-- כרטיס כניסה -->
  <div style='
    background:#fff; border:1px solid #E5EAF2; border-radius:16px;
    padding:36px 40px; width:100%; max-width:380px;
    box-shadow:0 8px 32px rgba(31,58,95,0.12); text-align:center;
  '>
    <div style='font-size:13px;color:#6B7280;margin-bottom:20px;letter-spacing:0.05em;font-weight:600'>
      PROFIT MIX OPTIMIZER
    </div>
    <div style='font-size:28px;font-weight:900;color:#1F3A5F;margin-bottom:6px'>
      כניסה למערכת
    </div>
...
""", unsafe_allow_html=True)
    ...
    with col_c:
        ...
        if is_default:
            st.markdown(
                '<div style="font-size:11px;color:#B45309;background:#FEF3C7;border-radius:6px;padding:6px 10px;margin-top:8px;text-align:center">'
...
<div class="pmo-header">
  <div class="pmo-header-left">
    <img src="{_PROFIT_LOGO}"
         style='height:44px;object-fit:contain;filter:brightness(0) invert(1);opacity:0.92'>
    <div style='margin-right:8px;border-right:1px solid rgba(255,255,255,0.25);padding-right:16px'>
...
QUICK_PROFILES_NEW = {
    ...
    "🇮🇱 ישראל": {"foreign_max": 10},
    '💱 מט"ח':   {"fx_min": 90},
    "🔵 כללי":   {"track_exact_word": "כללי"},  # רק מסלולים ששמם מכיל "כללי"
}
  ...
  <table class='res-tbl'>
    ...
    <tbody>{rows_h}</tbody>
        ...
        if not bar_df.empty:
            ...
            # שמות קצרים לציר X — מרכבים מ-2 שורות
            def _short(name):
                # לוקח מילה ראשונה ומספר/ספרות בסוף
                parts = name.split()
                if len(parts) <= 2:
                    return name
                # חותך אחרי 12 תווים
                return name[:12] + "…"
            short_names = [_short(n) for n in bar_df["קרן"]]
            fig = go.Figure(go.Bar(
                x=list(range(len(bar_df))),
                y=bar_df[bar_metric],
                marker_color=colors,
            ...
            fig.update_layout(
                ...
                xaxis=dict(
                    tickmode="array",
                    tickvals=list(range(len(bar_df))),
