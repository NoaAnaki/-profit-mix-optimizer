...
_PROFIT_LOGO = "data:image/svg+xml;base64,"
...
def _check_password() -> bool:
    ...
    # עמוד כניסה — כרטיס מרכזי עם לוגו בתוכו
    st.markdown(f"""
<div style='
  display:flex; flex-direction:column; align-items:center; justify-content:center;
  min-height:55vh; padding:20px;
'>
  <div style='
    background:#fff; border:1px solid #E5EAF2; border-radius:20px;
    padding:44px 48px 36px; width:100%; max-width:440px;
    box-shadow:0 12px 40px rgba(31,58,95,0.14); text-align:center;
  '>
    <!-- לוגו גדול בתוך הקוביה -->
    <img src="{_PROFIT_LOGO}"
         style='height:72px; margin-bottom:24px; object-fit:contain;'>
    <div style='width:40px;height:3px;background:#A31235;margin:0 auto 18px;border-radius:2px'></div>
    <div style='font-size:11px;color:#A31235;margin-bottom:10px;letter-spacing:0.12em;font-weight:700'>
      PROFIT MIX OPTIMIZER
    </div>
    <div style='font-size:26px;font-weight:900;color:#1F3A5F;margin-bottom:6px'>
      כניסה למערכת
    </div>
...
""", unsafe_allow_html=True)
    ...
    if all_locked_pairs:
        ...
        for prod, fund in all_locked_pairs:
            ...
            amt = st.number_input(
                f"{fund}  |  {prod}",
                min_value=0.0, value=cur_amt, step=1000.0,
                format="%.0f", key=f"lock_amt_{key_id}"
            )
    ...
    with col_d1:
        ...
        distrib_amt = st.number_input(
            ...
            min_value=0.0, value=cur_distrib, step=1000.0,
            format="%.0f", key="adv_distrib_amt"
        )
